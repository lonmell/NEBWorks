...
import com.krafte.kogas.databinding.ActivityOnebuttonPopBinding;
    ...
    private void setBtnEvent() {
        binding.popLeftTxt.setOnClickListener(v -> {
            if(data.equals("비밀번호가 성공적으로 변경되었습니다.") || data.equals("카카오 로그인에 문제가 생겼습니다.")){
                ...
                intent.setData(Uri.parse("https://play.google.com/store/apps/details?id=com.kraft.neb_employer"));
