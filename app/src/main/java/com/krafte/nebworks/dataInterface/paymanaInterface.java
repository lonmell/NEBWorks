...
public interface paymanaInterface
{
    ...
    //http://krafte.net/NEBWorks/pay/paymanager.php?flag=1&place_id=70&GET_DATE=2022-11-10&user_id=&basic_pay=&second_pay=&overwork_hour=&overwork_pay=&meal_allowance_yn=&meal_pay=&store_insurance_yn=&other_memo=&all_payment=&selectym=
    @FormUrlEncoded
    @POST("paymanager.php")
    Call<String> getData(
