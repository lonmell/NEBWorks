...
public interface paymanaInterface
{
    ...
    //http://krafte.net/NEBWorks/pay/paymanager.php?flag=1&place_id=183&GET_DATE=2023-04&user_id=199&basic_pay=&second_pay=&overwork_hour=&overwork_pay=&meal_allowance_yn=&meal_pay=&store_insurance_yn=&other_memo=&all_payment=&selectym=
    @FormUrlEncoded
    @POST("paymanager.php")
    Call<String> getData(
