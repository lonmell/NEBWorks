...
public class AssignmentMemberAdapter2 extends RecyclerView.Adapter<AssignmentMemberAdapter2.ViewHolder> {
    ...
    private static final String TAG = "AssignmentMemberAdapter2";
    ...
    public AssignmentMemberAdapter2(Context context, ArrayList<PlaceMemberListData.PlaceMemberListData_list> data) {
        this.mData = data;
    ...
    @NonNull
    @Override
    public AssignmentMemberAdapter2.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        View view = inflater.inflate(R.layout.assignment_member_item, parent, false);
        AssignmentMemberAdapter2.ViewHolder vh = new AssignmentMemberAdapter2.ViewHolder(view);
...
//            item_image = itemView.findViewById(R.id.item_image);
    ...
    // 리스너 객체 참조를 저장하는 변수
    private AssignmentMemberAdapter2.OnItemClickListener mListener = null;

    // OnItemClickListener 리스너 객체 참조를 어댑터에 전달하는 메서드
    public void setOnItemClickListener(AssignmentMemberAdapter2.OnItemClickListener listener) {
