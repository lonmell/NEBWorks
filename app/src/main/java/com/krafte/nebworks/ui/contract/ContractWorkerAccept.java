...
import com.krafte.nebworks.databinding.ActivityContractworkerAcceptBinding;
...
public class ContractWorkerAccept extends AppCompatActivity {
    private ActivityContractworkerAcceptBinding binding;
...
//        setContentView(R.layout.activity_community_add);
        binding = ActivityContractworkerAcceptBinding.inflate(getLayoutInflater());
    ...
    private void setBtnEvent(){
        ...
        binding.next.setOnClickListener(v -> {
            if(select05tf){
                pm.ContractWorkerSign(mContext);
            }else{
