...
public class ContractFragment3 extends Fragment {
    ...
    public static ContractFragment3 newInstance(int number) {
        ContractFragment3 fragment = new ContractFragment3();
                            ...
                            if (Response.length() == 0) {
                                ...
                                for (int i = 0; i < Response.length(); i++) {
                                    ...
                                    if(jsonObject.getString("contract_yn").equals("1")
                                            && !jsonObject.getString("owner_sign_id").equals("null")
                                            && !jsonObject.getString("worker_sign_id").equals("null")){
